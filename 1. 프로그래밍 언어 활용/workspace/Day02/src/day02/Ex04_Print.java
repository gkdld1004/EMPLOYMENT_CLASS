...
public class Ex04_Print {
	public static void main(String[] args) {
		...
		System.out.println("D" + "E" + "F");		// syso + 자동완성
		System.out.printf("G" + "H" + "I");
		
		System.out.println("end");
		
		int kor = 100, eng = 99, math = 87;
		double avg = (kor + eng + math) / 3.0;		// (double)3 으로 붙이는 것도 가능
		 ...
		 * 서식 제어 문자
		 * 
		 * %d : 10 진수			%02d : 숫자가 한자리면 앞에 0을 채운다
		...
		System.out.println(avg); 		// 서식제어를 해도 값의 변화는 없다
