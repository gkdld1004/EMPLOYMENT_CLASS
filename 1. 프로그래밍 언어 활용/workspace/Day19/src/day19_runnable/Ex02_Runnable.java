...
//	Runnable은 추상메서드를 하나만 가지는, 함수형 인터페이스이다 -> 람다식 객체 생성이 가능하다.
...
public class Ex02_Runnable {
	public static void main(String[] args) {
		...
		// 2) 자바에서는 다중상속을 허용하지 않으므로, 슈퍼클래스가 존재하는 경우 extends Thread 가 안된다.
		// 3) extends Thread 대신, implement Runnable 을 통해서 같은 과정을 구현할 수 있다.
		// 4) 생성한  Runnable 객체를 Thread 의 생성자 매개변수에 넣어주면 된다.
