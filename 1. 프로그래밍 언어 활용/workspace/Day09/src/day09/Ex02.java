...
public class Ex02 {
	public static void main(String[] args) {
		...
		// 기본 자료형으로 만들어 낼 수 있는 데이터의 형식은 제한이 많다.
		
		// 변수 : 자료형(크기)를 동반하여 메모리 공간을 확보하고 데이터를 저장하는 공간
		
		// 배열 : 같은 자료형의 여러 데이터를 연속적인 공간에 저장할 수 있는 구조
		
		// 구조체 : 서로 다른 자료형의 여러 데이터를 하나로 묶을 수 있는 사용자 정의 [자료형]	(C언어)
		//	ㄴ> 속성정보만 묶을 수 있고, 함수(기능)을 포함할 수 없다.
		...
		System.out.println(h1.name + "의 나이는 " + h1.age + "살입니다.\n");
