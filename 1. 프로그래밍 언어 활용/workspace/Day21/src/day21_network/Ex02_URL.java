...
public class Ex02_URL {
	...
	// URL : Uniform Resource Locater, 네트워크 상의 자원이 어디에 있는지 표시하는 형식
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Port : " + url.getPort());		// -1 은 프로토콜의 기본 포트 (80)
			...
			System.out.println("Protocol : " + url.getProtocol());
			System.out.println("Host : " + url.getHost());
			System.out.println("Port : " + url.getPort());		// -1 은 프로토콜의 기본 포트
			System.out.println("File : " + url.getFile());
			System.out.println();
