...
public class Ex01_While {
	...
	// public class는 소스 파일의 이름과 같아야 한다. - Hello.java파일의 public class는 Hello ☆
	// 클래스의 이름은 대소문자 및 언더바(_)를 사용하여 이름을 작성하고, 첫글자는 대문자로 처리한다.
	// 변수, 함수는 일반적으로 소문자로 시작하는 이름을 사용한다.
	// 여러 단어의 합성으로 만들어진 이름이라면, CamelCase를 사용하거나, snack_case로 이름을 작성한다.
