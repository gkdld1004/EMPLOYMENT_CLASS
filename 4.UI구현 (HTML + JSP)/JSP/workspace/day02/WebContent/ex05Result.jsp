...
<hr>
<%
	request.getParameter("여기에는 input 태그의 name 속성 문자열을 적는다");	// 반환자료형은 String
...
<div>
<%
	// 스크립틀릿은 원하는 곳에 작성해도 된다
	// 스크립틀릿이 중간에 끊어졌다가 다시 생성되어도, HTML상의 위치만 바뀔뿐, 처리되는 우선순위는 같다
...
<%
	...
	// 파라미터 마다 값의 개수도 다르고 변수 이름도 제각각 다르다면...?
%>
