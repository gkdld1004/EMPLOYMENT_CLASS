...
public class LifeCycleServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 작업을 수행한 이후 지정한 페이지로 포워딩 한다 (브라우저 주소창은 바뀌지 않는다)
		myFunction(req, resp);
	}
	...
	private void myFunction(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// 작업을 수행한 이후 지정한 페이지로 포워딩 한다 (브라우저 주소창은 바뀌지 않는다)
