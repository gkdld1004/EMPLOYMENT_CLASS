...
<hr>
<h2>표현식 : <%= map.get("apple") %>, <%= map.get("orange") %>,
<%=((HashMap<String, String>)session.getAttribute("map")).get("banana") %></h2>
<h2>EL Tag : ${map['apple'] }, ${map['orange'] }, ${map['banana'] } </h2>
<h2>EL Tag : ${map.apple }, ${map.orange }, ${map.banana } </h2>
<hr>
 
<p>map의 key는 array의 index와 같은 역할이다. 둘다 value에 접근하기 위한 데이터이다</p>
