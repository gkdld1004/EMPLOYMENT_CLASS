...
<body>
	...
	<form action="ex02Result.jsp" method="POST">
		...
		<%-- POST방식은 파라미터를 별도의 헤더에 포함하여 전달한다 (봉투에 담아서 전달, 주소창X) --%>
		
		<%-- GET 방식은 주소값 + 쿼리스트링의 크기가 최대 255자 까지 전달 가능 --%>
		<%-- GET (HTTP 1.1) 의 경우 최대 2048자 까지 전달 가능 --%>
		...
		<%-- POST 방식에서는 전달하는 데이터를 서버에 생성해라는 의미 --%>
