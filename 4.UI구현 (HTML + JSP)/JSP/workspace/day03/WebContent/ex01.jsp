...
<table border="1" cellspacing="0" cellpadding="10">
	...
	<tbody>
		<tr>
			...
			<td><%=request.getContextPath() %></td>
			<td>서버에서 기본문서 경로를 출력한다</td>
		</tr>
		<tr>
			<td>request.getMethod()</td>
			<td><%=request.getMethod() %></td>
			<td>클라이언트가 요청한 HTTP 방식을 출력한다 <br>(GET / POST / PUT / DELETE 등)</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><%=request.getCookies() %></td>
			<td>클라이언트가 요청하면서 첨부한 쿠키의 목록을 배열형태로 반환한다<br>즐겨찾기, 장바구니</td>
		</tr>
		<tr>
