...
<ul>
	...
	<li><strong class="red">c:choose</strong> : 여러 조건에 따라 다른 처리를 수행한다 (switch ~ case)</li>
	<li><strong class="red">c:forEach</strong> : 반복 처리를 위해서 사용, 횟수에 의한 반복, 컬렉션으로 반복 가능</li>
	<li><strong>c:forTokens</strong> : 구분자로 분리된 각각의 문자열 토큰을 처리한다</li>
	<li><strong>c:Import</strong> : url을 지정하여 외부 자원을 가져온다</li>
	<li><strong class="red">c:redirect</strong> : resonse.sendRedirect()와 동일한 기능</li>
