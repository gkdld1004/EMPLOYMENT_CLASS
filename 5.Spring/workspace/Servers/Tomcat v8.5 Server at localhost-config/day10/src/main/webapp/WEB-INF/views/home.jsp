...
<ul>
	<li><a href="<c:url value="/ex01" />">ex01 - 계정 이름으로 검색</a></li>
</ul>
...
<fieldset>
	...
	<p>현재는 XML 대신 json 형식을 더 많이 이용한다</p>
</fieldset>
...
<fieldset>
	...
	<p>DELECT	- delete 		: /members/{userid}</p>
	<p>위와 같은 요청을 자주 사용하기 위해 @GetMapping과 같은 어노테이션이 등장했다</p>
</fieldset>
